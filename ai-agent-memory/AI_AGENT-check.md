...
### 📋 每次任务开始必检项
- [ ] **检阅@AI_AGENT.md** - 确保理解最新的项目规范和要求
- [ ] **制定分步提交计划** - 识别任务中的各个步骤，在TodoWrite中为每个步骤添加对应的提交任务
- [ ] **完成任务内容预处理** - 分析now-task.md，生成optimized-task.md，确保任务目标清晰可执行
- [ ] **检查AI_AGENT文档变更状态** - 检查ai-agent-memory目录下所有以AI_AGENT开头的文件和now-task.md在上次git提交后是否有未提交的变更
...
### 📝 通用执行检查
- [ ] **强制分步提交机制** - 每完成一个步骤（单个文件重要修改、功能模块完成、阶段性成果、问题修复）后，必须立即进行仓库提交，严禁批量提交
- [ ] **TodoWrite同步更新** - 每次提交后立即将对应的TodoWrite任务标记为completed
...
### 📄 文档更新检查
- [ ] **更新AI_AGENT.md** - 相关变动是否写入@AI_AGENT.md
- [ ] **记录新约定** - 新增的约定或规范是否记录
...
### ✅ 质量保证检查
- [ ] **决策记录** - 重要设计决策是否在AI_AGENT.md中记录原因
